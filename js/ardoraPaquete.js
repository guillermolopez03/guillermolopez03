...
taboaContidos[0]=new act("Capitales de España","Capitales de España","","<object width='100%' height='420' type='text/html' data='Capitales/Capitales.htm'></object>",false,"",true,false,false);
taboaContidos[1]=new act("Relieve Terrestre","Relieve Terrestre","","<object width='100%' height='420' type='text/html' data='Relieve_terrestre/Relieve_terrestre.htm'></object>",false,"",true,false,false);
taboaContidos[2]=new act("Comunidades Autónomas","Comunidades Autónomas","","<object width='100%' height='420' type='text/html' data='Comunidades_aut__nomas/Comunidades_aut__nomas.htm'></object>",false,"",true,false,false);
taboaContidos[3]=new act("Adivinar las Comunidades","Adivinar las Comunidades","","<object width='100%' height='420' type='text/html' data='division_politica1/division_politica1.htm'></object>",false,"",true,false,false);
